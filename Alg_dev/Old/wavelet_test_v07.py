...
def get_image_array_from_coeffs():
	img_coeffs_adv = []
	for i in range(3):
...
# class SWA_attack_on_image:
# 	def __init__(image_array, K, wavelet, SWA_type):
# 		self.orig_image_array = image_array
# 		self.wavelet = wavelet
# 		self.attack = SWA_type
# 		self.K = K
