...
img_array_mask = get_image_array_from_coeffs(np.add(img_coeffs_array, (-1)*img_coeffs_array), img_coeffs_slices, wavelet)
...
plot_images_sbs(img, img_mask, img_mask, 1)
