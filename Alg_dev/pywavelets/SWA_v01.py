...
# Debug should be possible through studying http://pytorch.org/tutorials/beginner/blitz/tensor_tutorial.html
...
# The below function dosn't seem to work or really do anything ....
