...
def get_wav_image_from_tensor(coeff_tensor):
  temp = coeff_tensor.numpy()
...
if exit_status == 1:
  ...
  original_wav_tensor = calc_wav_coeffs_tensor_from_image_tensor(original_img_tensor, levels)
  mask_wav_tensor = calc_wav_coeffs_tensor_from_image_tensor(mask_img_tensor, levels)
  perturbed_wav_tensor = calc_wav_coeffs_tensor_from_image_tensor(perturbed_img_tensor, levels)
  original_wav_pil = get_wav_image_from_tensor(original_wav_tensor)
  mask_wav_pil = get_wav_image_from_tensor(mask_wav_tensor)
  perturbed_wav_pil = get_wav_image_from_tensor(perturbed_wav_tensor)
